...
exports.Lecture = (function(){
	...
	Lecture.prototype.getNewLectureCode = function(courseCode, lecturerUsername, callback) {
		...
		validateForLectureCode.courseCode = function(courseCodePartialCallback) {
			this.validateCourseCode(courseCode, function(courseCodeValidationError, validatedCourseCode) {
		...
		validateForLectureCode.lecturerUsername = function(lecturerUsernamePartialCallback) {
	...
	Lecture.prototype.joinLecture = function(lectureCode, deviceID, callback) {
		...
		validateForJoinLecture.deviceID = function(deviceIDPartialCallback) {
		...
		validateForJoinLecture.lectureCode = function(lectureCodePartialCallback) {
	...
	Lecture.prototype.leaveLecture = function(lectureCode, deviceID, callback) {
		...
		validateForLeaveLecture.lectureCode = function(lectureCodePartialCallback) {
			this.validateLectureCode(lectureCode, function(lectureCodeValidationError, validatedLectureCode){
				if (lectureCodeValidationError) lectureCodePartialCallback(lectureCodeValidationError, null);
				else lectureCodePartialCallback(null, validatedLectureCode);
			});
		};
		validateForLeaveLecture.deviceID = function(deviceIDPartialCallback) {
			this.validateDeviceId(deviceID, function(deviceIDValidationError, validatedDeviceID){
				if (deviceIDValidationError) deviceIDPartialCallback(deviceIDValidationError, null);
				else deviceIDPartialCallback(null, validatedDeviceID);
			});
	...
	Lecture.prototype.submitUnderstandingLevel = function(lectureCode, deviceID, understandingLevel, callback) {
		...
		validateForUnderstanding.lectureCode = function(lectureCodePartialCallback) {
			this.validateLectureCode(lectureCode, function(lectureCodeValidationError, validatedLectureCode) {
				if (lectureCodeValidationError) lectureCodePartialCallback(lectureCodeValidationError, null);
				else lectureCodePartialCallback(null, validatedLectureCode);
			});
		};
		validateForUnderstanding.deviceID = function(deviceIDPartialCallback) {
			this.validateDeviceId(deviceID, function(deviceIDValidationError, validatedDeviceId) {
				if (deviceIDValidationError) deviceIDPartialCallback(deviceIDValidationError, null);
				else deviceIDPartialCallback(null, validatedDeviceId);
			});
		};
		validateForUnderstanding.understandingLevel = function(understandingLevelPartialCallback) {
